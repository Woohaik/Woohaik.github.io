...
const Body = () => {
    return (
        <div className="profile dark:bg-dark bg-white z-10 navbar rounded-md">
            ...
            <hr />
            <Link className="h-[50px] flex justify-center place-items-center hover cursor-pointer" to="/files/Wilfredo-Hernandez-CV.pdf" target="_blank" download>Descargar Curriculum</Link>
        </div>
    );
};
