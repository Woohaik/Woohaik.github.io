...
const NavbarItem: FC<IProps> = (props: IProps) => {
    return (
        <NavLink
            ...
            to={props.to}
        >
            <div className="hover text-center flex navbar__item place-items-center p-2 rounded-md flex-col-reverse after:bg-primary justify-center cursor-pointer" onClick={() => console.log(props.to)}>
